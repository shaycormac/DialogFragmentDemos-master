...
import com.example.haoz.dialogfragmentdemos.utils.OnDialogResultListener;
...
public class DialogActivity extends AppCompatActivity {
    ...
    private void showTimeDialog() {
        ...
        DialogFragmentHelper.showTimeDialog(getSupportFragmentManager(), titleTime, calendarTime, new OnDialogResultListener<Calendar>() {
            @Override
    ...
    private void showPasswordInsertDialog() {
        ...
        DialogFragmentHelper.showPasswordInsertDialog(getSupportFragmentManager(), titlePassword, new OnDialogResultListener<String>() {
            @Override
    ...
    private void showListDialog() {
        ...
        DialogFragmentHelper.showListDialog(getSupportFragmentManager(), titleList, languanges, new OnDialogResultListener<Integer>() {
            @Override
    ...
    private void showIntervalInsertDialog() {
        ...
        DialogFragmentHelper.showIntervalInsertDialog(getSupportFragmentManager(), title, new OnDialogResultListener<String[]>() {
            @Override
            public void onResult(String[] result) {
    ...
    private void showInsertDialog() {
        ...
        DialogFragmentHelper.showInsertDialog(getSupportFragmentManager(), titleInsert, new OnDialogResultListener<String>() {
            @Override
            public void onResult(String result) {
                showToast(result);
            }
    ...
    private void showDateDialog() {
        ...
        mDialogFragment = DialogFragmentHelper.showDateDialog(getSupportFragmentManager(), titleDate, calendar, new OnDialogResultListener<Calendar>() {
            @Override
            public void onResult(Calendar result) {
                showToast(String.valueOf(result.getTime().getDate()));
            }
    ...
    private void showConfirmDialog() {
        DialogFragmentHelper.showConfirmDialog(getSupportFragmentManager(), "是否选择 Android？", new OnDialogResultListener<Boolean>() {
            @Override
